    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {["This Year", "Last Year"].map((l, _i) => (
            <button key={l} style={{ padding: "7px 14px", borderRadius: 6, border: "1px solid #e5e7eb", background: _i === 0 ? "#003580" : "#fff", color: _i === 0 ? "#fff" : "#374151", fontWeight: 600, fontSize: 13, cursor: "pointer" }}>{l}</button>
          ))}
        </div>
      </div>
              ...
              <div key={r.name}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ width: 20, height: 20, borderRadius: "50%", background: "#f1f5f9", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: "#374151", flexShrink: 0 }}>{idx + 1}</span>
      ...
      <div style={{ background: "#003580", borderRadius: 10, padding: "20px 28px", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0 }}>
        {[
          ...
          <div key={s.label} style={{ textAlign: "center", padding: "0 16px", borderRight: idx < 3 ? "1px solid rgba(255,255,255,0.12)" : "none" }}>
